...
@Component("currencynotsupportedStep3SecondNudge")
class Step3SecondNudge implements CurrencyNotSupportedStep {
	...
	public void execute(RecoveryCase recoveryCase, RecoveryAction action) {
		ops.sms(recoveryCase, "Reminder: complete ₹" + recoveryCase.getAmountAtRisk() + " on the link (DEV SMS)");
