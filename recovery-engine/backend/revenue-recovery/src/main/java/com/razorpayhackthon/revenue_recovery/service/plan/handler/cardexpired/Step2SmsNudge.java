...
@Component("cardexpiredStep2SmsNudge")
class Step2SmsNudge implements CardExpiredStep {
	...
	public String planNote() {
		return "Step 2: SMS nudge to update the expired card";
	}

	@Override
	public void execute(RecoveryCase recoveryCase, RecoveryAction action) {
		ops.sms(recoveryCase, "Your card has expired. Use the payment link to pay ₹"
