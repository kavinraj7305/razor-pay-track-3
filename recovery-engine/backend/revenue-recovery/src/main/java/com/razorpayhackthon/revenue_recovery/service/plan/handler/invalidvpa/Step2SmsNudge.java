...
@Component("invalidvpaStep2SmsNudge")
class Step2SmsNudge implements InvalidVpaStep {
	...
	public String planNote() {
		return "Step 2: SMS nudge to use a valid VPA";
	}

	@Override
	public void execute(RecoveryCase recoveryCase, RecoveryAction action) {
		ops.sms(recoveryCase, "UPI ID did not work. Use the payment link to pay ₹"
