...
@Component("cardnotenrolledStep1SendPayLink")
class Step1SendPayLink implements CardNotEnrolledStep {
	...
	public String planNote() {
		return "Step 1: send a link so they can complete 3DS or pick another method";
	}
